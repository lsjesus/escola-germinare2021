    ...
    return(
        ...
        <section className="estagios">
            ...
            <div className="estagios-section">
                <div className="estagios-container lider"  data-aos='fade-up' data-aos-duration='500' data-aos-easing='ease'>
                ...
                <div className="estagios-container vendedor" data-aos='fade-left' data-aos-duration='500' data-aos-easing='ease'>
                    <div className='format-estagios-container' >
                ...
                <div className="estagios-container gerente" data-aos='fade-left' data-aos-duration='500' data-aos-easing='ease'>
                    <div className='format-estagios-container'>
                ...
                <div className="estagios-container programador" data-aos='fade-left' data-aos-duration='500' data-aos-easing='ease'>
                    <div className='format-estagios-container'>
                        <h1 className="estagios-name">Programador</h1>
                        <p className="estagios-description">Os alunos que escolherem e tiverem habilidades para a área de Tecnologia, têm a oportunidade de aplicar os conhecimentos de programação dentro do maior aplicativo de pagamentos do Brasil. Após passar pela área de operações do PicPay, os alunos aplicam o que aprendem sobre desenvolvimento de sistemas, experiência do usuário e gestão da tecnologia na prática. Todos os estudantes da Germinare, possuem aula de tecnologia desde o sexto ano do fundamental e ao decorrer de sua caminhada pela escola, desenvolvem uma série de habilidades, incluindo: Programação em Python, HTML, CSS, JavaScript, análise de dados, domínio de bancos de dados SQL, metodologia ágil dentre outros diversos conhecimentos. </p>
                    </div>
                </div>
                <div className="estagios-container financeiro" data-aos='fade-left' data-aos-duration='500' data-aos-easing='ease'>
                    <div className='format-estagios-container'>
