...
const Donation = () => {
    return(
        <section className='donation'>
            ...
            <p className='text'>Para apoiar, você pode fazer uma doação para a Escola Germinare através do PicPay, para isso basta escanear o Qr Code abaixo e pagar tanto com seu saldo em carteira ou com seu cartao de credito!</p>
